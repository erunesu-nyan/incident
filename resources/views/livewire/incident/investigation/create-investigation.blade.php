        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                <div>
                    ...
                    <textarea id="result" class="block mt-1 w-full" name="result" wire:model="investigationFormModel.result" required ></textarea>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <select id="severity" name="status"
                        ...
                        wire:model="investigationFormModel.status"
                    >
